...
export function createEventsTool(client: Bitrix24ApiClient): ToolDefinition {
  return createActionTool(
    ...
    ["bind", "unbind", "get", "offline_list", "offline_clear", "offline_execute", "get_supported", "get_list"],
    {
    ...
    client,
    {
      ...
      offline_execute: "Execute offline event queue", get_supported: "List supported event names", get_list: "List subscriptions",
    },
  );
}