...
export function createCalendarTool(client: Bitrix24ApiClient): ToolDefinition {
  return createActionTool(
    ...
    ["event_add", "event_get", "event_list", "event_update", "event_delete", "event_get_nearest", "section_list", "section_add", "section_update", "section_delete", "meeting_status_set", "resource_list", "accessibility_get", "settings_get"],
    {
      id: P.id,
    ...
    client,
    {
      event_add: "Create an event (NAME, DT_FROM, DT_TO)", event_get: "Get an event by ID",
      event_list: "List events in a date range", event_update: "Update event fields",
      ...
      meeting_status_set: "Set meeting attendance status (Y/N/Q)",
      resource_list: "List bookable resources", accessibility_get: "Get user availability for a date range",
      settings_get: "Get current user calendar settings",
    },
  );
}