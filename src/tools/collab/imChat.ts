...
export function createImChatTool(client: Bitrix24ApiClient): ToolDefinition {
  return createActionTool(
    ...
    ["add", "get", "updateTitle", "updateColor", "updateAvatar", "setOwner", "setManager", "user_add", "user_list", "user_delete", "leave", "mute", "sendMessage", "editMessage", "deleteMessage", "searchMessages", "readAll", "uploadFile", "getCounters"],
    {
      ...
      MANAGER_ACTION: { type: "string", enum: ["set", "unset"], description: "Manager action: set or unset" },
    ...
    },
    {
      ...
      setManager: { restMethod: "im.chat.set.manager", httpVerb: "POST", pathParams: ["CHAT_ID"], bodyParam: "USER_ID", bodyWrapper: "userId" },
      ...
      searchMessages: { restMethod: "im.dialog.messages.search", httpVerb: "GET", queryParams: ["CHAT_ID", "SEARCH"] },
    ...
    client,
    {
      ...
      setOwner: "Set a new chat owner", setManager: "Set/unset a chat manager (USER_ID)",
      user_add: "Add users (USERS array)", user_list: "List chat users",
