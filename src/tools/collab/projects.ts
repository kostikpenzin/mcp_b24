...
export function createProjectsTool(client: Bitrix24ApiClient): ToolDefinition {
  return createActionTool(
    ...
    ["create", "get", "list", "update", "delete", "user_list", "user_add", "user_delete", "set_owner", "feature_set", "feature_get", "request_list"],
    {
    ...
    client,
    {
      ...
      user_list: "List group members", user_add: "Add a member", user_delete: "Remove a member (destructive)",
