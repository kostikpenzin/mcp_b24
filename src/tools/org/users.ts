...
export function createUsersTool(client: Bitrix24ApiClient): ToolDefinition {
  return createActionTool(
    ...
    ["current", "get", "listByDepartment", "search", "fields", "userfield_get", "userfield_add", "userfield_update", "userfield_delete", "add", "update", "delete"],
    {
    ...
    client,
    {
      ...
      userfield_get: "Get a custom user field", userfield_add: "Create a custom user field",
