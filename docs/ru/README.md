...
Полный MCP-сервер над REST API Битрикс24: **43 инструмента**, ~870 действий, webhook + OAuth 2.0, RU/EN, MIT.
...
| [TOOLS_REFERENCE.md](./TOOLS_REFERENCE.md) | Все | Полный реестр 43 инструментов и действий |
